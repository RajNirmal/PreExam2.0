...
public class Exam1 extends AppCompatActivity implements OnTouchListener, OnClickListener {
		...
		question.setOnTouchListener(new OnSwipeTouchListener(
			...
			public void onSwipeRight() {
				...
				if (selected > 1) {
					selected--;
					refresh();
					Animation a = AnimationUtils.loadAnimation(Exam1.this,
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (flag) {
					...
					AlertDialog.Builder b = new AlertDialog.Builder(Exam1.this);
