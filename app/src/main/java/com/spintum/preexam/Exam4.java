...
public class Exam4 extends AppCompatActivity implements OnTouchListener, OnClickListener {
		...
		question.setOnTouchListener(new OnSwipeTouchListener(
			...
			public void onSwipeRight() {
				...
				if (selected > 1) {
					selected--;
					refresh();
					Animation a = AnimationUtils.loadAnimation(Exam4.this,
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (flag) {
					...
					AlertDialog.Builder b = new AlertDialog.Builder(Exam4.this);
