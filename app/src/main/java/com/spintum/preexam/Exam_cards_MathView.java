...
public class Exam_cards_MathView extends Activity implements View.OnClickListener{
    TabLayout tabs;
    MathView showText;
    View Opt1,Opt2,Opt3,Opt4;
    MathView Opt1Text, Opt2Text,Opt3Text,Opt4Text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_cards_mathview);
        tabs = (TabLayout)findViewById(R.id.exam_tablayout);
        showText = (MathView)findViewById(R.id.question_holder);
        Opt1Text = (MathView)findViewById(R.id.answer_1_text);
        Opt2Text = (MathView) findViewById(R.id.answer_2_text);
        Opt3Text = (MathView) findViewById(R.id.answer_3_text);
        Opt4Text = (MathView) findViewById(R.id.answer_4_text);
...
// To dismiss the dialog
    ...
    private void ChangeDollartoSlash(){
        String test;
        //Toast.makeText(getApplicationContext(),Questions[0],Toast.LENGTH_SHORT).show();
        for(int i=0 ; i<=19 ; i++) {
            test = Answer1[i];
            //test.replace('$','\\');
            Questions[i]=test;
