...
public class Fragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup container, Bundle SavedInstances) {
        ...
        final View subView = getActivity().getLayoutInflater().inflate(R.layout.fragment4, null);
    ...
    public void data() {
        ...
        if ((!sc.equals(""))) {
            ...
            if (percent.length >= 0) {
                ...
                total.addView(new Fragment4.PercentCircle(getActivity(), 0, length), 0);
            ...
            if (values.length > 0) {
                ...
                last.addView(new Fragment4.PercentCircle(getActivity(), lscore[0] * 5, scores[0] + " "), 0);
                ...
                View chart = new Fragment4.chart(getActivity(), manhattan);
                chart.animate().rotation(180);
            ...
            total.setLayoutParams(new LinearLayout.LayoutParams(w / 4, h / 7));
            total.addView(new Fragment4.PercentCircle(getActivity(), 0, "0"), 0);
            percent1.setText("0%");
            percent2.setText("0%");
            percent3.setText("0%");
            ...
            last.removeAllViews();
            last.setLayoutParams(new LinearLayout.LayoutParams(w / 4, h / 7));
            last.addView(new Fragment4.PercentCircle(getActivity(), 0, "0" + ""), 0);
            header.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, h / 5));
            LinearLayout.LayoutParams p = new LinearLayout.LayoutParams(w, (int) ((float) h * 0.30));
            p.setMargins(20, 30, 20, 0);
            p.gravity = Gravity.CENTER_HORIZONTAL;
